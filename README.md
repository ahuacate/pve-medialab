...
### 5.4 Unprivileged container mapping - Ubuntu 18.04
...
### 5.5 Create NZBGet download folders on your ZFS typhoon-share - Ubuntu 18.04
...
### 5.6 Create new "media" user - Ubuntu 18.04
...
### 5.7 Install NZBget - Ubuntu 18.04
...
### 5.8 Edit NZBget configuration file - Ubuntu 18.04
...
### 5.9 Create NZBget Service file - Ubuntu 18.04
...
### 7.1 Install Jackett - Ubuntu 18.04
This is easy. First start LXC 113 (deluge) with the Proxmox web interface go to `typhoon-01` > `113 (deluge)` > `START`.
...
### 7.2 Create Jackett Service file - Ubuntu 18.04
Go to the Proxmox web interface `typhoon-01` > `113 (deluge)` > `>_ Shell` and type the following:
```
echo -e "[Unit]
...
## 8.0 Flexget LXC - Ubuntu 18.04
Under Development.

---

## 9.0 Sonarr LXC - Ubuntu 18.04
Sonarr is a PVR for Usenet and BitTorrent users. It can monitor multiple RSS feeds for new episodes of your favorite shows and will grab, sort and rename them. It can also be configured to automatically upgrade the quality of files already downloaded when a better quality format becomes available.

### 9.1 Create a Ubuntu 18.04 LXC for Sonarr
Now using the web interface `Datacenter` > `Create CT` and fill out the details as shown below (whats not shown below leave as default):
...
### 9.2 Setup Sonarr Mount Points - Ubuntu 18.04
...
### 9.4 Create Sonarr Service file - Ubuntu 18.04
...
## 10.0 Radarr LXC - Ubuntu 18.04
Sonarr is a PVR for Usenet and BitTorrent users. It can monitor multiple RSS feeds for new episodes of your favorite shows and will grab, sort and rename them. It can also be configured to automatically upgrade the quality of files already downloaded when a better quality format becomes available.

### 10.1 Create a Ubuntu 18.04 LXC for Radarr
Now using the web interface `Datacenter` > `Create CT` and fill out the details as shown below (whats not shown below leave as default):
...
### 10.2 Setup Radarr Mount Points - Ubuntu 18.04
...
```
### 10.4 Create Radarr Service file - Ubuntu 18.04
...
## 11.0 Lidarr LXC - Ubuntu 18.04
Lidarr is a music collection manager for Usenet and BitTorrent users. It can monitor multiple RSS feeds for new tracks from your favorite artists and will grab, sort and rename them. It can also be configured to automatically upgrade the quality of files already downloaded when a better quality format becomes available.

### 11.1 Create a Ubuntu 18.04 LXC for Lidarr
Now using the web interface `Datacenter` > `Create CT` and fill out the details as shown below (whats not shown below leave as default):
...
### 11.2 Setup Lidarr Mount Points - Ubuntu 18.04
...
```
### 11.4 Create Lidarr Service file - Ubuntu 18.04
...
## 12.0 Lazylibrarian LXC - Ubuntu 18.04
...
### 12.1 Create a Ubuntu 18.04 LXC for Lazylibrarian
Now using the web interface `Datacenter` > `Create CT` and fill out the details as shown below (whats not shown below leave as default):
...
### 12.2 Setup Lazylibrarian Mount Points - Ubuntu 18.04
